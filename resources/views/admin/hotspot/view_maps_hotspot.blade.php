...
<div class="page-title-box">
    <div class="row align-items-center">
        <div class="col-sm-6">
            <h4 class="page-title">Maps HotSpot Point</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-right">
                <li class="breadcrumb-item"><a href="javascript:void(0);">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ url('administrator/hospot-view') }}">Data Maps HotSpot</a></li>
                <li class="breadcrumb-item active">Maps HotSpot Point</li>
            </ol>
        </div>
    </div>
    <!-- end row -->
...
@section('app_js')
@include('admin.hotspot.js.view_maps_js')
