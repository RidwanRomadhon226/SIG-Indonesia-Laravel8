    ...
    <div class="row align-items-center">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-right">
                ...
                <li class="breadcrumb-item"><a href="{{ url('administrator/kecamatan-view') }}">Data  hostpot</a></li>
        ...
        <div class="card-body">
            ...
            <form method="post" action="#" enctype="multipart/form-data" > @csrf
                <div class="form-group">
                    <label>lokasi</label>
                    <input type="text" name="lokasi" class="form-control" required placeholder="Lokasi HotSpot"/>
                </div>
                <div class="form-group ">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12 row">
                        <input type="text" name="lat" class=" mr-2 col-sm-5 form-control" required placeholder="lat"/>
                        <input type="text" name="lng" class=" col-sm-5 form-control" required placeholder="lng"/>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <div class="input-group">
                            <input type="text" name="tanggal" class="form-control" required placeholder="yyyy-mm-dd" id="datepicker-autoclose">
                ...
                <div class="form-group">
                    ...
                    <div>
                        <textarea required class="form-control" name="keterangan" rows="5"></textarea>
                    </div>
                </div>
