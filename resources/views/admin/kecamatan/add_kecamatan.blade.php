...
<div class="col-lg-6">
    <div class="card m-b-30">
        <div class="card-body">
            ...
            <form method="post" action="{{ url('administrator/kecamatan-add') }}" enctype="multipart/form-data" > @csrf
                <div class="form-group">
                    <label>Kode Kecamatan</label>
                    <input type="text" name="kd_kecamatan" class="form-control" required placeholder="Kode Kecamatan"/>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="geojson_kecamatan" class="form-control" required placeholder="Nama Kecamatan"/>
                </div>
                <div class="form-group">
                    <label>Input Warna Poligon</label>
                    <input type="text" name="warna_kecamatan" class="colorpicker-default form-control" required placeholder="Pilih Warna">
                </div>
                <div class="form-group">
                    <div>
